...
import { Hourglass, Oval, Vortex } from "react-loader-spinner";

const Home = () => {


    const { appData, spinner, setSpinner } = useContext(AppContext);
    useEffect(() => {
        setSpinner(true)
        setTimeout(() => {
            setSpinner(false)
    ...
    return (
        <div className="space-y-20 mb-5">
            {
                spinner ? <span className="flex font-bold justify-center items-center text-7xl my-52">
                    L<Vortex
                        visible={true}
